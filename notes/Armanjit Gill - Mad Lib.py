...
print("Sometimes there is a story mode, last time you had to %s the %s %s, it was the most %s way to %s characters." % (verb4, adjective2, person2, adjective3, verb5))
print("In the game, you can play as characters like %s or %s. Sadly, they didn’t add in %s." % (character, character2, character3))
...
print("You shouldn't choose characters who are %s or %s. I heard that they might add %s, %s characters, %s or!" % (adjective4, adjective5, character4, adjective6, character5))
