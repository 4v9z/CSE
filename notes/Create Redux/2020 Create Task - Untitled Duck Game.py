...
oplat7 = Plat("obsidianplat.png", 0, 82)
lplat7 = LavaPlat("lava plat.png", 510, 200)
lplat8 = LavaPlat("lava plat.png", 510, 200)
lplat9 = LavaPlat("lava plat.png", 510, 200)
lplat10 = LavaPlat("lava plat.png", 510, 200)
lplat11 = LavaPlat("lava plat.png", 510, 200)
lplat12 = LavaPlat("lava plat.png", 510, 200)
lplat13 = LavaPlat("lava plat.png", 510, 200)
lplat14 = LavaPlat("lava plat.png", 510, 200)
